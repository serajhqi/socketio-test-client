...
<div class="flex flex-row items-center justify-between border-b border-burning py-3">
 <div class="flex flox-row items-center px-2">
  ...
  <div class="flex flex-row justify-between px-4 ml-5 items-center">
    <HelpModal/>
    <a href="https://github.com/serajhqi/socketio-test-client" target="_blank" class="flex flex-row items-center text-white px-1 rounded-sm text-xs font-bold h-6">
      <svg
        style="fill:white"
        ...
        /></svg
      >
      <div class="flex ml-1 whitespace-nowrap">Star | {starCount}</div>
    </a>
